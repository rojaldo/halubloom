...
class Group(object):
    ...
    """
    def __init__(self, id=1, name=None, lamps=None):
        """
    ...
    def lamps(self):
        """
        Gets the lamps of this Group.

        :return: The lamps of this Group.
        :rtype: list[int]
        """
        return self._lamps
    ...
    def lamps(self, lamps):
        """
        Sets the lamps of this Group.

        :param lamps: The lamps of this Group.
        :type: list[int]
        """
