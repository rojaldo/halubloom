...
class OtaFile(object):
    ...
    def __init__(self, accesspoint=None):
        """
        OtaFile - a model defined in Swagger
    ...
    def accesspoint(self):
        """
        Gets the accesspoint of this OtaFile.

        :return: The accesspoint of this OtaFile.
        :rtype: str
        """
    ...
    def accesspoint(self, accesspoint):
        """
        Sets the accesspoint of this OtaFile.

        :param accesspoint: The accesspoint of this OtaFile.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, OtaFile):
            return False
