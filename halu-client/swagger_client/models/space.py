...
class Space(object):
    ...
    """
    def __init__(self, id=None, name=None, lamps=None):
        """
    ...
    def lamps(self):
        """
        Gets the lamps of this Space.

        :return: The lamps of this Space.
        :rtype: list[int]
        """
        return self._lamps
    ...
    def lamps(self, lamps):
        """
        Sets the lamps of this Space.

        :param lamps: The lamps of this Space.
        :type: list[int]
        """
