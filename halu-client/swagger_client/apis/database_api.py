...
class DatabaseApi(object):
    ...
    def get_database(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_database(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_database_with_http_info(**kwargs)
        else:
            (data) = self.get_database_with_http_info(**kwargs)
            return data

    def get_database_with_http_info(self, **kwargs):
        """
        The database is where the master lamp saves all the data.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_database_with_http_info(callback=callback_function)
        ...
        resource_path = '/master/database'.replace('{format}', 'json')
        path_params = {}
