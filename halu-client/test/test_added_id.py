...
from swagger_client.models.added_id import AddedId


class TestAddedId(unittest.TestCase):
    """ AddedId unit test stubs """
    ...
    def testAddedId(self):
        """
        Test AddedId
        """
        model = swagger_client.models.added_id.AddedId()
