...
from swagger_client.apis.discovery_api import DiscoveryApi
...
class TestDiscoveryApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.discovery_api.DiscoveryApi()
    ...
    def test_modify_discovery(self):
        """
        Test case for modify_discovery
