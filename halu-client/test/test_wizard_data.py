...
from swagger_client.models.wizard_data import WizardData


class TestWizardData(unittest.TestCase):
    """ WizardData unit test stubs """
    ...
    def testWizardData(self):
        """
        Test WizardData
        """
        model = swagger_client.models.wizard_data.WizardData()
